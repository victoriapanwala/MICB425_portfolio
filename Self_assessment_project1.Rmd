...
Edited the abstract a bit. Initially it said that only oxygen concentrations were significant, but they werent, it was NH4 concentrations only for the OTU based data. After we recieved the feedback on project 1, I also made the suggested edits.
...
I edited the introduction as well, and combined my and Ian's sections on planctomycetes. After we recieved the feedback on project 1, I also made the suggested edits.
...
I made some gramatical edits to the methods section after it was written. I also compiled the total reference list: since we each worked on the sections separately, there were reference sections for each of the individual sections. After we recieved the feedback on project 1, I also made the suggested edits. 
...
Made some gramatical changes in the analysis of figures 3a-f and table 1. After we recieved the feedback on project 1, I also made the suggested edits.
...
I also added another paragraph on some of the reasons for the differences between OTU and ASV data, and the reasons why significance varies for the same linear relationship analysis conducted using data from both pipelines. The addition of this paragraph brought the discussion section up to 750 words.

### Editing

I also edited the discussion to make it more concise, and free of grammatical errors. After we recieved the feedback on project 1, I also made the suggested edits.
